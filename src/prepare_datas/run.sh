...
#python voc_process.py --VOC-dir=/data/VOC/VOCdevkit/VOC2012 --anno-file /data/VOC/VOCdevkit/VOC2012/ImageSets/Main/trainval.txt --out-file ../../datas/VOC/trainval_voc12.txt --save-name trainval_record_voc12  --cmd-type readvoc
...
python voc_process.py --anno-file ../../datas/COCO/coco2017.txt --out-file ../../datas/COCO/coco2017m.txt   --cmd-type filter